# my_project/auth/dao/orders/workplace_repair_dao.py

from ..general_dao import GeneralDAO
from .... import db
from ...domain.orders.workplace_repair import WorkplaceRepair


class WorkplaceRepairDAO(GeneralDAO):
    model = WorkplaceRepair
