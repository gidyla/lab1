...
class ExchangeService(db.Model, IDto):
    ...
    device_type = db.relationship('DeviceType', backref='exchange_service')
    ...
    @staticmethod
    def create_from_dto(dto_dict: Dict[str, Any]) -> ExchangeService:
        obj = ExchangeService(**dto_dict)
        return obj
